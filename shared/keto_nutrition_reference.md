...
Core stack: D3 + K2 · Omega-3 (EPA/DHA) · creatine · low-sodium salt blend (NaCl + KCl, iodized) · magnesium glycinate stack (+ zinc, copper, B6) · citrulline malate · caffeine · beef collagen + vitamin C (pre-training) · Brazil nuts (selenium).
...
- **With largest/evening meal:** magnesium glycinate + zinc + copper + B6; omega-3; D3 + K2.
