---
taskId: monthly-nutrition-review
description: Monthly nutrition + supplement review (Denis & Alicja) with research — 1st Sunday at 19:00
cronExpression: "0 19 1-7 * 0"
enabled: true
note: Read-only; recommends data.json nutrition edits but never makes them.
---
