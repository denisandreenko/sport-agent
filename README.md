...
`weekly-review-and-plan` (Sunday 18:00) and `monthly-nutrition-review` (1st of the month, 19:00) also
run on a schedule. `daily-session-brief` is registered but **paused** — activate it when a training
block starts. See `.claude/skills/README.md`.
